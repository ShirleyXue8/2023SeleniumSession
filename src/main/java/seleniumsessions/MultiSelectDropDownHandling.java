...
//		select.deselectAll();
		...
		selectDropDownMultipleValues(dropDownLocator, optionLocator,"American flamingo","American flamingo","Greater flamingo","Lesser flamingo");
...
//		selectDropDownMultipleValues(dropDownLocator,optionLocator, "all");
	 ...
	 * 3.All Selection:Please pass"all" as a value all the values
	 * @param locator
	 * @param values
	 */
