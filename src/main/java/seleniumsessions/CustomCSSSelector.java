...
//		By.cssSelector("input[name='email']");
		...
		//input[id='input-email'][placeholder='E-Mail Address'][type='text']
...
//		driver.findElement(By.className("form-control private-form__control login-email")).sendKeys("naveen@gmai.com");//invalid
		//InvalidSelectorException: Compound class names not permitted
		
//		driver.findElement(By.className("login-email")).sendKeys("naveen@gmai.com");//valid
		
//		driver.findElement(By.xpath("//input[@class='form-control private-form__control login-email']")).sendKeys("naveen@gmai.com");//valid
		
//		driver.findElement(By.cssSelector("input.form-control.private-form__control.login-email")).sendKeys("naveen@gmai.com");//valid
